...
![Billing](https://github.com/Shurlormes/btgfw/blob/master/fig/Billing.jpg)

## 2.3 购买服务器

点击vultr网页右上角的蓝色+图标即可为账户添加服务器。
![addServer](https://github.com/Shurlormes/btgfw/blob/master/fig/addServer.jpg)
...
![服务器地点](https://github.com/Shurlormes/btgfw/blob/master/fig/服务器地点.jpg)

第二个选项为选择服务器类型（Server Type），即选择服务器操作系统。建议选择Debian 7 x64，默认没有防火墙，会减少很多麻烦。
![服务器类型](https://github.com/Shurlormes/btgfw/blob/master/fig/服务器类型.jpg)
...
![服务器大小](https://github.com/Shurlormes/btgfw/blob/master/fig/服务器大小.jpg)
...
![服务器标签](https://github.com/Shurlormes/btgfw/blob/master/fig/服务器标签.jpg)
...
![服务器信息](https://github.com/Shurlormes/btgfw/blob/master/fig/服务器信息.jpg)
...
![新建会话](https://github.com/Shurlormes/btgfw/blob/master/fig/新建会话.jpg)

连接成功之后会出现命令提示符：`root@username:~#`
![新建会话](https://github.com/Shurlormes/btgfw/blob/master/fig/Xshell.jpg)
...
![导入ssr连接](https://github.com/Shurlormes/btgfw/blob/master/fig/导入ssr连接.jpg)

初始的时候软件里会有一台免费的服务器，由于SSR作者已经没有维护了，是不能用的，需要将其删除掉，然后确定。如图所示：
![删除公用服务器](https://github.com/Shurlormes/btgfw/blob/master/fig/删除公用服务器.jpg)
...
![SwitchyOmega选项](https://github.com/Shurlormes/btgfw/blob/master/fig/SwitchyOmega选项.jpg)
...
![autoSwitch](https://github.com/Shurlormes/btgfw/blob/master/fig/autoSwitch.jpg)

情景模式中的proxy配置如下图所示，其中127.0.0.1:1080为SSR代理地址，只有流向这个地址的流量SSR才会处理。
![proxy](https://github.com/Shurlormes/btgfw/blob/master/fig/proxy.jpg)

设定中的初始情景模式选择auto switch，如图所示。这样当检测到目标地址在GFW列表中的时候chrome会让其走SSR代理。否则直连。
![初始情景模式](https://github.com/Shurlormes/btgfw/blob/master/fig/初始情景模式.jpg)

然后重启chrome，保证SwitchyOmega运行在auto switch模式，否则可能无法正常使用，常见现象有无法访问国外网站、导致访问国内网站速度变慢或无法访问内网等。如图所示：
![确定状态](https://github.com/Shurlormes/btgfw/blob/master/fig/确定状态.jpg)
...
![代理模式直连模式](https://github.com/Shurlormes/btgfw/blob/master/fig/代理模式直连模式.jpg)

右键小飞机代理规则改为“全局”，如图所示：
![全局代理规则](https://github.com/Shurlormes/btgfw/blob/master/fig/全局代理规则.jpg)
...
GitHub：[https://github.com](https://github.com/Shurlormes/btgfw)
